# Project overlay — VibecodeKit Hybrid Ultra v0.23.0

This project uses the VibecodeKit **v0.23.0** overlay (canonical version
...
Before shipping:
1. `pytest tests/ -q` → 1535/1535 pass at v0.23.0 (full suite, run từ repo
   ...
   full suite.
2. `/vibe-audit` → 92/92 internal regression probes (self-test, not external benchmark)
