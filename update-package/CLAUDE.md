# Project overlay — VibecodeKit Hybrid Ultra v0.24.0

This project uses the VibecodeKit **v0.24.0** overlay (canonical version
...
Before shipping:
1. `pytest tests/ -q` → 1731+/1731+ pass at v0.24.0 (full suite, run từ repo
   ...
   full suite.
2. `/vibe-audit` → 95/95 internal regression probes (self-test, not external benchmark)
