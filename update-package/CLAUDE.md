# Project overlay — VibecodeKit Hybrid Ultra v0.19.0

This project uses the VibecodeKit **v0.19.0** overlay (canonical version
...
Before shipping:
1. `pytest tests/ -q` → 588/588 pass at v0.19.0 (full suite, run từ repo
