...
// Regenerate via:
//   python3 -m vibecodekit.cli scaffold tokens-export --scaffold shop-online
...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      // shop-online: vck-energy is canonical "Buy now" CTA, vck-warning for stock alerts.
      colors: {
      ...
      // FP-01 Modern Tech (shop default; luxury fashion may swap to FP-02).
      fontFamily: {
