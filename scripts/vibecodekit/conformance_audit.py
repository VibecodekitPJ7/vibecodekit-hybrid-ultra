...
Each of the 93 patterns in the methodology maps to a *probe* — a small
...
(see its ``__init__.py``):
  ...
  ``conformance/probes_governance.py``  – probes #71-93 (security / case-studies / design-tokens)
...
# ``"93_…"`` last).  Any future probe added with
