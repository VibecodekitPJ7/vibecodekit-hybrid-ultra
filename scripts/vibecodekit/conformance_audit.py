...
Each of the 92 patterns in the methodology maps to a *probe* — a small
...
(see its ``__init__.py``):
  ...
  ``conformance/probes_governance.py``  – probes #71-92 (security / case-studies)
...
# ``"92_…"`` last).  Any future probe added with
