# VibecodeKit Hybrid Ultra — Hướng dẫn sử dụng chi tiết (v0.18.0)

Bộ kit đầy đủ để build dự án theo phương pháp **VIBECODE-MASTER** với **Full
Agentic OS** runtime (87 internal conformance probes at v0.18.0 — self-test, not external benchmark; see `BENCHMARKS-METHODOLOGY.md`; all
...
Bản này ứng với **v0.18.0** (hiện hành — xem `CHANGELOG.md` cho
...
| `/vibe-audit` | Chạy 87 conformance probes (at v0.18.0). |
