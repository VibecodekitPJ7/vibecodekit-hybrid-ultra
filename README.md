...
> **Current release:** v0.19.0 ([CHANGELOG](CHANGELOG.md)) — see [Layout](#layout) below for the surface inventory (42 slash commands, 7 sub-agent roles, 33 hook events, 87 conformance probes, …).
>
...
**Surface inventory (v0.19.0)** — moved here from the opening to keep
